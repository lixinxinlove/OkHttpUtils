...
public class GsonUtils {
	...
	public static JsonObject getJsonObjByString(String json) {
		JsonObject obj = new JsonParser().parse(json).getAsJsonObject();
		return obj;
	}
	...
	public static ChimelongResponseEntity asJSONToResponseEntity(String json) {
		JsonObject obj = new JsonParser().parse(json).getAsJsonObject();
		...
		ChimelongResponseEntity entity = new ChimelongResponseEntity();
		entity.code = code;
